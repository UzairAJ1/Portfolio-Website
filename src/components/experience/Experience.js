...
const Experience = () => {
  return (
    <div className=' container mx-auto w-10/12 relative h-screen flex flex-col justify-center gap-6 items-center flex-shrink-0 md:pt-12 pt-2  md:p-8 p-2'>
        ...
        <div className='flex overflow-x-auto snap-x snap-mandatory gap-2  scrollbar scrollbar-thumb-amber-500 scrollbar-track-[#3C3C3C] h-4/5 pb-8 px-6 w-11/12'>
